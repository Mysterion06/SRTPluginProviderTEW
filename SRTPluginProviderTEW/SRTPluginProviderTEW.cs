...
{
    public class SRTPluginProviderTEW : IPluginProvider
    {
        private Process process;
        private GameMemoryTEWScanner gameMemoryScanner;
        ...
        public int Startup(IPluginHostDelegates hostDelegates)
        {
            ...
            process = GetProcess();
            gameMemoryScanner = new GameMemoryTEWScanner(process);
        ...
        private Process GetProcess() => Process.GetProcessesByName("evilwithin")?.FirstOrDefault();
    }
}
